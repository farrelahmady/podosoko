$(document).ready(function () {
	...
	const imageURL = "assets/img/slideshow/";

	const slidePage = document.createElement("div");
	slidePage.id = "slide";
	const slideShowPage = document.getElementById("slide-show");
	// const arrRight = document.querySelector("#home .r");
	// const arrLeft = document.querySelector("#home .l");
	...
	const slideShow = {
		...
		run: function () {
			...
			$("html").css(
				"--slideshow-img-url",
				"url('../img/slideshow/" + this.background
			);
